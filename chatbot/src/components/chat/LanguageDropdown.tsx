...
const getLanguageFlag = (lang: TargetLanguage): string => {
  const flags: Record<TargetLanguage, string> = {
    [TargetLanguage.ENGLISH]: "/flags/english_flag.png",
    [TargetLanguage.KOREAN]: "/flags/korean_flag.png",
    [TargetLanguage.SPANISH]: "/flags/spanish_flag.png",
  };
  return flags[lang];
};
    ...
    <div className={styles.languageDropdown} ref={dropdownRef}>
      ...
      {isOpen && (
        <div className={styles.dropdownMenu}>
          {(
            availableLanguages ||
            (Object.values(TargetLanguage) as TargetLanguage[])
          ).map((lang) => (
            <div
              key={lang}
